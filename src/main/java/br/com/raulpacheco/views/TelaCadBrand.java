 ...
 * @author house
 */
public class TelaCadBrand extends JFrame implements BaseMenuButtonsInterface {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadBrand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadBrand().setVisible(true);
            }
        });
    }
