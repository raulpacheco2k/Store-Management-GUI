 ...
 * @author house
 */
public class TelaCadProductType extends JFrame implements BaseMenuButtonsInterface {

    /**
     * Creates new form FormModeloCadastros
     */
    public TelaCadProductType() {
        initComponents();
    }
        ...
        jPanelDadosLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDadosLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDadosLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(nome, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadProductType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadProductType().setVisible(true);
            }
        });
    }
