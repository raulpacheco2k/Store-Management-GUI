 ...
 * @author house
 */
public class TelaCadSize extends JFrame implements BaseMenuButtonsInterface {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Cadastro de Tamanho");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadSize.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadSize().setVisible(true);
            }
        });
    }
